...
use Illuminate\Support\Facades\Auth; // 2021-10-27
...
class EventsController extends Controller
{
    ...
    public function show(Event $event, $view = 'eventmie::events.show', $extra = [])
    {
        ...
        $my_bookings = $tickets_data['my_bookings'];
//print_r($my_bookings); exit;
        ...
        return Eventmie::view($view, compact(
            ...
            'tickets', 'currency', 'booked_tickets', 'total_capacity', 'extra', 'my_bookings'));
    }
    ...
    protected function get_tickets($event_id = null)
    {
        ...
        return [
            ...
            'my_bookings' => $my_bookings, // 2021-10-27
        ];
    }
