...
class Dashboard extends Controller
{
    ...
    public function export_sales_report(Request $request, $user_id = null)
    {
        ...
        foreach($sales_report as  $key => $item)
        {
            ...
            $csvData[$key][ __('voyager::generic.Logged In')]  = $item['checked_in'] > 0 ? __('eventmie-pro::em.yes') : __('eventmie-pro::em.no') ; // 2021-10-26
...
// 2021-10-26 cols
        ...
        $csvData[count($sales_report) + 1][ __('voyager::generic.Logged In')]  = null; // 2021-10-26
...
// 2021-10-26 cols
        ...
        $csvExporter->build($csvData, [
            ...
            'Booking Date',
            //'Checked In',
            'Logged In', // 2021-10-26
            'Ticket',
            'Order Total',
//            'Organiser',
            'Event Manager', // 2021-10-26
// 2021-10-26
            'Organiser Earning',
            'Admin Commission',
            'Admin Tax',
