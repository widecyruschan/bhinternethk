                ...
                <nav class="navbar navbar-default lgx-navbar navbar-expand-lg">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav lgx-nav navbar-right">
                            ...
                            <li>
                                <a class="lgx-scroll lgx-btn lgx-btn-sm" href="{{ route('eventmie.events_index') }}"><img src="/frontend-assets?path=img/Event_black.svg" width="20"> @lang('eventmie-pro::em.browse_events')</a>
                            </li>
