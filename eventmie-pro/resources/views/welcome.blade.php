                        ...
                        <div class="main-search">
                            <form class="form-inline" type="GET" action="{{route('eventmie.events_index')}}">
                                <div class="form-group input-group event-search">
                                    ...
                                    <img src="/frontend-assets?path=img/Event_black.svg" width="30">
                                    </span>
...
<section>
    ...
    <div class="lgx-inner" style="background: #000 url({{ eventmie_asset('img/line.png') }}) top center;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="lgx-heading lgx-heading-white">
                            <h2 class="heading">
                                ...
                                @lang('eventmie-pro::em.top_selling_events')</h2>
                        </div>
                    </div>
                </div>
...
<!-- <section>
    ...
    <div class="lgx-inner" style="background: url({{ eventmie_asset('img/778.png') }}) top center;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="lgx-heading">
    ...
    <div>
        <div class="lgx-inner">
            <div class="container">
                ...
                <div class="section-btn-area">
                    <a class="lgx-btn" href="{{route('eventmie.get_posts')}}">@lang('eventmie-pro::em.view_all_blogs')</a>
                </div>
            </div><!-- //.CONTAINER -->
        </div><!-- //.INNER -->
    </div>
...
<script type="text/javascript">
	    $(document).ready(function(){
            jQuery("#indexHome").css('display','none');
