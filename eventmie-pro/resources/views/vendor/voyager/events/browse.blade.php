                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($row->type == 'text')
                                                    ...
                                                    @if($row->getTranslatedAttribute('display_name') == 'Online Location')
                                                        ...
                                                        @endif
                                                    @elseif($row->field == 'review_link') <!-- // 2021-10-27 -->
                                                        @if($data->{$row->field})
                                                            {{ __('voyager::generic.yes') }}
                                                        @endif
                                                    @else
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @if($data->publish > 0 && ! $data->review_link) <!-- // 2021-10-27 -->
                                                <a href="https://bh.internethk.com/bhcam2/admin.php" class="btn btn-sm btn-info pull-right" target="_blank">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">{{ __('voyager::generic.cam') }}</span>
                                                </a>
                                            @endif
