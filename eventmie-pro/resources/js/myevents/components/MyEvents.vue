                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr v-for="(event, index) in events" :key="index" >
                            ...
                            <td :data-title="trans('em.start_date')">{{ changeDateFormat(convert_date_to_local(event.start_date), 'YYYY-MM-DD') }}</td>
                            <td :data-title="trans('em.end_date')">{{ changeDateFormat(convert_date_to_local(event.end_date), 'YYYY-MM-DD') }}</td>
                            <td :data-title="trans('em.start_time')">{{ convert_time_to_local(event.start_date, event.start_time, 'hh:mm:ss A') }}</td>
                            <td :data-title="trans('em.end_time')">{{ convert_time_to_local(event.end_date, event.end_time, 'hh:mm:ss A') }}</td>
