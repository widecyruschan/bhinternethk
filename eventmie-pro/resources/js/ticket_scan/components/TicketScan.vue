    ...
    <div>
        <div v-if="Object.keys(booking).length > 0">
            ...
            <table class="table table-striped table-hover ">
                ...
                <td>
                    <p class="text-bold text-small">{{ moment(convert_date_to_local(booking.event_start_date)).format(date_format.vue_date_format)+' - '+moment(convert_date_to_local(booking.event_end_date)).format(date_format.vue_date_format) }}</p>
                    <p class="text-bold text-small">{{ convert_time_to_local(booking.event_start_date, booking.event_start_time, date_format.vue_time_format)+' - '+convert_time_to_local(booking.event_end_date, booking.event_end_time, date_format.vue_time_format) }}</p>
                </td>
                </tr>
