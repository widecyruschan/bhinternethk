            ...
            <div class="panel panel-default lgx-panel">
                <div class="panel-heading">
                    <form ref="form" @submit.prevent="cropThumbnailPoster" method="POST" enctype="multipart/form-data" class="lgx-contactform form-horizontal">
                        ...
                        <!-- div class="form-group" >
                            <label class="col-sm-2 control-label">{{ trans('em.review_link') }} Multi-Cam ({{ trans('em.optional') }})</label>
                            <div class="col-md-6">
                                1. <input type="text" class="form-control" name="review_link1" placeholder="e.g 253989945" v-model="review_link1" @change="isDirty()">
                                2. <input type="text" class="form-control" name="review_link2" placeholder="e.g 253989945" v-model="review_link2" @change="isDirty()">
                                3. <input type="text" class="form-control" name="review_link3" placeholder="e.g 253989945" v-model="review_link3" @change="isDirty()">
                                4. <input type="text" class="form-control" name="review_link4" placeholder="e.g 253989945" v-model="review_link4" @change="isDirty()">
                                5. <input type="text" class="form-control" name="review_link5" placeholder="e.g 253989945" v-model="review_link5" @change="isDirty()">
                                6. <input type="text" class="form-control" name="review_link6" placeholder="e.g 253989945" v-model="review_link6" @change="isDirty()">
                                <span class="help-block">{{ trans('em.enter_video_id_only') }}: https://vimeo.com/<strong>253989945</strong></span>
                            </div>
                        </div -->
                        ...
                        <div class="form-group" v-if="review_link > '' ">
                            ...
                            <span v-show="errors.has('review_desc')" class="help text-danger">{{ errors.first('review_desc') }}</span>
                        </div>
    ...
    methods: {
        ...
        editMedia(){
            ...
            if(Object.keys(this.event).length > 0)
            {
                ...
                // this.review_link3              = this.event.review_link3;
                // this.review_link4              = this.event.review_link4;
                // this.review_link5              = this.event.review_link5;
                // this.review_link6              = this.event.review_link6;
                this.review_desc               = this.event.review_desc;
            }
        },
