                    ...
                    <form ref="form" @submit.prevent="validateForm" method="POST" enctype="multipart/form-data" class="lgx-contactform">
                       ...
                       <!-- Only show this to admin -->
                        ...
                        <div class="form-group hidden">
                            <label>{{ trans('em.select_event_type') }}</label>
                            <select name="event_type" class="form-control" v-model="event_type" v-validate="'required'" @change="isDirty()">
                                <option value="">-- {{ trans('em.select_event_type') }} --</option>
                                <option value="live">{{ trans('em.event_live') }}</option>
                                <option value="recorded">{{ trans('em.event_recorded') }}</option>
                            </select>
                            <span v-show="errors.has('event_type')" class="help text-danger">{{ errors.first('event_type') }}</span>
                        </div>
                        -->
                        ...
                        <div class="form-group hidden" v-if="is_admin">
                            <input type="checkbox" class="custom-control-input" :value=1 name="status" checked >
...
//                this.event_type     = this.event.event_type; // 2021-10-26.
