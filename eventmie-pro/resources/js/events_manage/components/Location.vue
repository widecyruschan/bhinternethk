                ...
                <div class="panel-heading">
                    ...
                    <form ref="form" @submit.prevent="validateForm" method="POST" enctype="multipart/form-data" class="lgx-contactform">
                        ...
                        <div class="form-group">
                            <input disabled type="checkbox" class="custom-control-input" name="online_event" checked v-model="online_event" :value="1" @change="isDirty()">
                            <label class="custom-control-label" >{{ trans('em.online_event') }}</label>
                        </div>

                        <div class="form-group hidden" v-if="online_event > 0">
