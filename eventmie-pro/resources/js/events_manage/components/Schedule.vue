                ...
                <div class="panel-title">
                    <div class="schedule-number">
                        <div class="schedule-info">
                            <h4 class="time">#{{sch_index+1}} <span>{{ trans('em.schedule') }}</span></h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    methods: {
        ...
        updateSchedule() {
            ...
            this.update({ 
                ...
                v_from_time         : moment(this.convert_time(this.from_time),'HH:mm:ss').locale('en').format('HH:mm:ss'),
                v_to_time           : moment(this.convert_time(this.to_time),'HH:mm:ss').locale('en').format('HH:mm:ss'),
            });
        },
        ...
        schedule_total_days(){
            ...
            ))
            {
                ...
                if(this.months[0]== this.month && this.months.length != 1)
                {
                    ...
                    this.repetitive_dates.forEach(function(v,k){
                        ...
                        if(moment(this.local_start_date, "YYYY-MM-DD").locale('en').format('DD') <= v.value)
                        {
                            count_d     = count_d - 1;
                            total       = count_d; 
                        }    
                ...
                else if(this.months[this.months.length-1] == this.month && this.months.length != 1)
                {
                    ...
                    this.repetitive_dates.forEach(function(v,k){
                        ...
                        if(moment(this.local_end_date, "YYYY-MM-DD").locale('en').format('DD') >= v.value)
                        {
                            count_d     = count_d - 1;
                            total       = count_d; 
                ...
                else if(this.months.length == 1)
                {
                    ...
                    this.repetitive_dates.forEach(function(v,k){
                        ...
                        if(moment(this.local_start_date,"YYYY-MM-DD").locale('en').format('DD') <= v.value && moment(this.local_end_date,"YYYY-MM-DD").locale('en').format('DD') >= v.value)
                        {
                            count_d     = count_d - 1;
                            total       = count_d; 
           ...
           // use this condition when user create event
                ...
                all_dates.forEach(function(value, key){
                    $_this.repetitive_days.forEach(function(value1, key1){
                        ...
                        if(moment(value).format('dddd') == value1.text)
                        {
                            ...
                            {   
                                // selected date must be grather than start date
                                if(moment(this.local_start_date,"YYYY-MM-DD").locale('en').format("DD") <= moment(value).locale('en').format('DD'))  
                                {
                                    total = count++;
                                }                        
                            } 
                            ...
                            {
                                // selected date must be less than end date
                                if(moment(this.local_end_date,"YYYY-MM-DD").locale('en').format("DD") >= moment(value).locale('en').format('DD'))
                                    total = count++;                     
                            ...
                            {   
                                // selected date must be less than end date and grather than start date
                                if(moment(this.local_start_date,"YYYY-MM-DD").locale('en').format('DD') <= moment(value).locale('en').format('DD') && 
                                    moment(this.local_end_date,"YYYY-MM-DD").locale('en').format('DD') >= moment(value).locale('en').format('DD')
                                   )
                                {   
                                    total = count++; 
                                }       
            ...
            {   
                ...
                {
                    var repetitive_dates     = this.schedules.repetitive_dates.split(',');  
                    ...
                    if(this.months[0] == this.month && this.months.length != 1)
                    {
                        ...
                        repetitive_dates.forEach(function(v,k){
                            // selected dates must be grather than start date
                            if(moment(this.local_start_date,"YYYY-MM-DD").locale('en').format('DD') <= v)
                            {
                                count_d     = count_d - 1;
                                total       = count_d; 
                            }    
                    ...
                    else if(this.months[this.months.length-1] == this.month && this.months.length != 1)
                    {
                        ...
                        repetitive_dates.forEach(function(v,k){
                           ...
                           // selected dates must be less than end date
                            if(moment(this.local_end_date, "YYYY-MM-DD").locale('en').format('DD') >= v)
                            {
                                count_d     = count_d - 1;
                                total       = count_d; 
                    ...
                    all_dates.forEach(function(value, key){
                        repetitive_days.forEach(function(value1, key1){
                            ...
                            if(moment(value).locale('en').format("dddd") == value1)
                            {
                                ...
                                {   
                                    // selected date must be grather than start date
                                    if(moment(this.local_start_date).format("DD") <= moment(value).format('DD'))  
                                    {
                                        total = count++;
                                    }                        
                                } 
                                ...
                                {
                                    // selected date must be less than end date
                                    if(moment(this.local_end_date).format("DD") >= moment(value).format('DD'))
                                        total = count++;                     
                                ...
                                else if(this.months.length == 1)
                                {
                                    // selected date must be less than end date and grather than start date
                                    if(moment(this.local_start_date).format('DD') <= moment(value).format('DD') && 
                                        moment(this.local_end_date).format('DD') >= moment(value).format('DD')
                                    )
                                    {   
                                        total = count++; 
                                    }   
