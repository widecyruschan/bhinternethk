...
class DataRowsTableSeeder extends Seeder
{
    ...
    protected function posts()
    {
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Event Type", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 0, "details" => "{}", "order" => 3, ])->save();
        }
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Friendly URL", "required" => 1, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "slugify" => [
                "origin" => "title",
                "forceUpdate" => true
            ],
    ...
    protected function events()
    {
        ...
        if (!$dataRow->exists) {
        $dataRow->fill(["type" => "select_dropdown", "display_name" => "Repetitive", "required" => 0, "browse" => 0 /* // 2021-10-14 */, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "default" => "1",
        "options" => [
                "1"=>"Yes",
                "0"=>"No",
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "relationship", "display_name" => "Event Manager" /* // 2021-10-14 */, "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        ...
        $dataRow = $this->dataRow($DataType, "slug");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Friendly URL", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "max:512"
            ],
        "slugify" => [
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "select_dropdown", "display_name" => "Payment Frequency", "required" => 1, "browse" => 0 /* // 2021-10-14 */, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "default" => "1",
        "options" => [
                "1"=>"Monthly/Weekly",
                "0"=>"Full Advance",
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Online Location", "required" => 0, "browse" => 0 /* // 2021-10-14 */, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 36, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "excerpt");
        if (!$dataRow->exists) {
    ...
    protected function categories()
    {
        ...
        $dataRow = $this->dataRow($DataType, "slug");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Friendly URL", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
    ...
    protected function bookings()
    {
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Event Manager Id", "required" => 0, "browse" => 0, "read" => 0, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 8, ])->save();
        }
        ...
        if (!$dataRow->exists) {
            ...
            // 2021-10-26
            $dataRow->fill(["type" => "select_dropdown", "display_name" => "Logged In", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "default" => "1",
        "options" => [
                "1"=>"Yes",
                "0"=>"No",
    ...
    protected function commissions()
    {
        ...
        if (!$dataRow->exists) {
            ...
            // 2021-10-26
            $dataRow->fill(["type" => "text", "display_name" => "Event Manager Id", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 2, ])->save();
        }
        ...
        if (!$dataRow->exists) {
            ...
            // 2021-10-26
            $dataRow->fill(["type" => "text", "display_name" => "Event Manager Earning", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 6, ])->save();
        }
    ...
    protected function tags()
    {
        ...
        if (!$dataRow->exists) {
            ...
            // 2021-10-26
            $dataRow->fill(["type" => "organiser", "display_name" => "Event Manager", "required" => 1, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 2, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "description");
        if (!$dataRow->exists) {
