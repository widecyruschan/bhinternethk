...
//                "display_name" => "Multi Organisation/Vendor Mode",
                "display_name" => "Multi Event Manager Mode", // 2021-10-13
                "value" => "1",
                "details" => json_encode([
                    "validation" => [
                        "rule" => "in:0,1,on,off"
                ...
                "order" => "21",
//                "group" => "Multi-vendor",
                "group" => "Event Manager", // 2021-10-13
            ])->save();
        }
...
//            ]), "type" => "select_dropdown", "order" => "48", "group" => "Multi-vendor", ])->save();
            ]), "type" => "select_dropdown", "order" => "48", "group" => "Event Manager", ])->save(); // 2021-10-13
        }
...
//            ]), "type" => "select_dropdown", "order" => "49", "group" => "Multi-vendor", ])->save();
            ]), "type" => "select_dropdown", "order" => "49", "group" => "Event Manager", ])->save(); // 2021-10-13
        }
...
//            $setting->fill(["display_name" => "Manually Approve Organizer", "value" => "0", "details" => json_encode([
            $setting->fill(["display_name" => "Manually Approve Event Manager", "value" => "0", "details" => json_encode([ // 2021-10-13
                "default" => "0",
                "options" => [
                    "Disabled",
                    "Enabled"
...
//            ]), "type" => "select_dropdown", "order" => "50", "group" => "Multi-vendor", ])->save();
            ]), "type" => "select_dropdown", "order" => "50", "group" => "Event Manager", ])->save();  // 2021-10-13
        }
