...
class DataRowsTableSeeder extends Seeder
{
    ...
    protected function events()
    {
        ...
        if (!$dataRow->exists) {
            ...
            // 2021-10-26
            $dataRow->fill(["type" => "relationship", "display_name" => "Event Manager", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
    ...
    protected function tags()
    {
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "organiser", "display_name" => "Event Manager" /* // 2021-10-14 */, "required" => 1, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 2, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "description");
        if (!$dataRow->exists) {
