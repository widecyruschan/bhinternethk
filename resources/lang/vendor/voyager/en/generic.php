...
return [
    ...
    'Organisers'                => 'Event Managers', // 2021-10-26
    'Revenue'                   => 'Revenue',
    ...
    //"Organiser"                 => "Organiser",
    "Organiser"                 => "Event Manager", // 2021-10-26
    "Country"                   => "Country",
    ...
    "Organiser Id"              => "Event Manager Id", // 2021-10-26
    "Event Id"                  => "Event Id",
    "Ticket Id"                 => "Ticket Id",
    "Quantity"                  => "Quantity",
    "Price"                     => "Price",
    ...
    "Logged In"                 => "Logged In", // 2021-10-26
    "Booking Id"                => "Booking Id",
    "Admin Commission"          => "Admin Commission",
    "Customer Paid"             => "Customer Paid",
    //"Organiser Earning"         => "Organiser Earning",
    "Organiser Earning"         => "Event Manager Earning", // 2021-10-26
    "Transferred"               => "Transferred",
    "Month Year"                => "Month Year",
    "Type"                      => "Type",
    //"Organizer"                 => "Organizer",
    "Organizer"                 => "Event Manager", // 2021-10-26
    "Sub Title"                 => "Sub Title",
    "Website"                   => "Website",
    ...
    "payouts_info"              => "Event Manager Earnings needs to be transferred to Event Manager", // 2021-10-26
    "refunds"                   => "Refunds",
    "settlement"                => "Settlement",
    //"refunds_info"              => "Organizer Earnings needs to be claimed back from Organizer",
    "refunds_info"              => "Event Manager Earnings needs to be claimed back from Event Manager", // 2021-10-26
    //"organizer_bank"            => "Organizer Bank Details",
    "organizer_bank"            => "Event Manager Bank Details", // 2021-10-26
