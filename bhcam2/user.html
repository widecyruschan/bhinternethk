                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="flex-row-item col-4 col-md-4 col-xs-6 video">
                                            <video id="camera-1" data-id="1" poster="cam.png" style="width: 100%;" muted></video>
                                        </div>
                                        <div class="flex-row-item col-4 col-md-4 col-xs-6 video">
                                            <video id="camera-2" data-id="2" poster="cam.png" style="width: 100%;" muted></video>
                                        </div>
                                        <div class="flex-row-item col-4 col-md-4 col-xs-6 video">
                                            <video id="camera-3" col-4 col-md-4 col-xs-6 data-id="3" poster="cam.png" style="width: 100%;" muted></video>
                                        </div>
                                
                                        <div class="flex-row-item col-4 col-md-4 col-xs-6 video">
                                            <video id="camera-4" data-id="4" poster="cam.png" style="width: 100%;" muted></video>
                                        </div>
                                        <div class="flex-row-item col-4 col-md-4 col-xs-6 video">
                                            <video id="camera-5" data-id="5" poster="cam.png" style="width: 100%;" muted></video>
                                        </div>
                                        <div class="flex-row-item col-4 col-md-4 col-xs-6 video">
                                            <video id="camera-6" data-id="6" poster="cam.png" style="width: 100%;" muted></video>
                                        </div>
                                    </div>
                                </div>
                        </div>
